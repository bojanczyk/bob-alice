...
\begin{myexample}
  ...
  However, the inclusion is strict: \kl[of protocol]{protocols} are more powerful than
...
\begin{myexample}
    ...
    automaton}, but cannot be computed by a \kl[of protocol]{protocol}.
    We do not know yet if
    \kl{nondeterministic orbit-finite automata} can simulate all \kl[of protocol]{protocols}, 
    and therefore for
    ...
    inclusion, since we believe that \kl[of protocol]{protocols}
