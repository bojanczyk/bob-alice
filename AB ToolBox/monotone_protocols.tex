...
Now we want to show that every function computed by a monotone protocol is rational.
First, we define the notion of \emph{Hankel Property} for every function $f \colon \Sigma^* \to \Gamma^*$. Then we state the Reutenauer-Schützenberger Theorem that every function with Hankel Property is rational.
...
\begin{theorem}[Reutenauer-Schützenberger Theorem]
  ...
  Every function $f \colon \Sigma^* \to \Gamma^*$ that has the Hankel Property is rational. \cite{reutenauerSchutzenberger1991}
\end{theorem}
