...
\begin{proof}
    ...
    configuration. The number of steps in a crossing sequence is bounded by twice the number of states, since otherwise the automaton would enter an infinite loop. This bound is the number of rounds in the protocol. In each round,
