...
In this section, we consider the case where the output domain is strings over
...
$\Gamma$ are finite. For such functions, the protocols are assumed to use the
...
exactly the so-called regular functions, which will be formally defined in
