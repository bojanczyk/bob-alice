...
The main result of this section is that our protocol is equivalent to weighted automata.
...
The rest of this section is devoted to proving the theorem. Before proving it, we return to the issue of division, which was already discussed in Example~\ref{ex:division}.
