...
\begin{center}
    ...
    \kl[String domain]{Strings} & Two-way automat with output (\cref{conj:protocol-regular-string-to-string}) \\
...
and they need to decide if the input string is in the language or not. As mentioned before, the parties have unbounded computational power. For example, the first message sent by Alice could answer  some undecidable question.
