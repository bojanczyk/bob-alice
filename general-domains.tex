...
\begin{definition}\label{def:two-party-protocol-general} \AP A \intro{two-party protocol}
...
\begin{proof}
 ...
 \mb{If you want to add a short proof, that would be nice! But we can still keep the sentence that it is the same proof.}
\end{proof}

Later in this paper, we will study \kl[orbit-finite protocols]{protocols for infinite input alphabets}.
Such protocols will not be a special case of the \kl{protocols} developed so far,
since the signal spaces will be infinite, albeit in a limited way (called
\kl{orbit-finite}).  As we will see, for such signal spaces the reduction to
