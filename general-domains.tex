...
\begin{proof}
  ...
  \begin{align*}
    (Q_A)^k \to \domain^{dk}
  \end{align*}
  for Bob. These functions can be included in the first message that each party sends, and therefore the same construction as in the proof of \cref{lem:one-round-reduction-boolean} applies.
\end{proof}
